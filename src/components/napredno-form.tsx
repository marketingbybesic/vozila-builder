...
// Zimske (st.66), Cjelogodišnje (st.67), i Teretne i C/Moto i ATV/Agro i
// industrijske gume + Aluminijske/Čelične felge/Kompleti/Ratkape (st.68, svih
// 7 odjednom) dodane identično. Preostale 3 od 13 djece (tpms-senzori,
// distancijeri-prstenovi, gume-felge-ostalo) NISU zatražene — ne dirati dok
// se izričito ne zatraži.
...
export function NaprednoForm({ embedded = false, onClose }: { embedded?: boolean; onClose?: () => void } = {}) {
  ...
  // preimenovati je posvuda — vidi TIRE_FULL_FORM_VRSTE niže za dijeljeni
