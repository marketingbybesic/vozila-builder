...
const DOSTAVNA_RAW: CarMake[] = [
  ...
  M("chevrolet", "Chevrolet", "SAD", ["Harvester"]),
  M("citroen", "Citroën", "Francuska", ["Berlingo", "Jumpy", "Jumper", "Nemo", "ë-Berlingo", "ë-Jumpy", "ë-Jumper"]),
  M("dacia", "Dacia", "Rumunjska", ["Dokker Van", "Logan Van", "Duster Van", "Dokker", "Duster"]),
  M("daihatsu", "Daihatsu", "Japan"),
  M("daf", "DAF", "Nizozemska"),
  M("dfm", "DFM", "Kina", ["Dongfeng"]),
  M("elaris", "Elaris", "Njemačka"),
  M("farizon", "Farizon", "Kina", ["SV", "V7E"]),
  M("fiat", "Fiat", "Italija", ["Doblo Cargo", "Fiorino", "Scudo", "Talento", "Ducato", "E-Ducato", "E-Scudo", "E-Doblo", "Doblo"]),
  M("ford", "Ford", "SAD", ["Transit", "Transit Custom", "Transit Connect", "Transit Courier", "E-Transit", "E-Transit Custom", "Tourneo Custom", "Tourneo Connect", "Ranger"]),
  M("fort", "Fort", "Kina"),
  M("foton", "Foton", "Kina", ["Aumark", "Cavan", "Toano", "Tunland", "View"]),
  M("gaz", "GAZ", "Rusija"),
  M("giotti-victoria", "Giotti Victoria", "Italija"),
  M("goupil", "Goupil", "Francuska", ["G4", "G2"]),
  M("hyundai", "Hyundai", "Južna Koreja", ["H-1", "H350", "Staria Van", "Porter", "H100"]),
  M("imv", "IMV", "Italija"),
  M("isuzu", "Isuzu", "Japan", ["D-Max", "N-Series", "M21"]),
  M("iveco", "Iveco", "Italija", ["Daily", "eDaily", "Eurocargo"]),
  M("kia", "KIA", "Južna Koreja", ["K-2500", "K-2700", "K-2900", "PV5"]),
  ...
  M("maxus", "Maxus", "Kina", ["eDeliver", "Deliver 9", "EV80"]),
  M("mazda", "Mazda", "Japan", ["B-2500", "BT-50"]),
  M("mercedes-benz", "Mercedes-Benz", "Njemačka", ["Citan", "Vito", "eVito", "V-klasa", "Sprinter", "eSprinter", "Vaneo"]),
  M("mitsubishi", "Mitsubishi", "Japan", ["L200", "L300", "Fuso Canter", "L-200"]),
  M("nextem", "Nextem", "Italija"),
  M("nissan", "Nissan", "Japan", ["NV200", "e-NV200", "NV250", "NV300", "NV400", "Townstar", "Primastar", "Navara", "Interstar"]),
  M("om", "OM", "Italija"),
  M("opel", "Opel", "Njemačka", ["Combo Cargo", "Combo-e", "Vivaro", "Vivaro-e", "Movano", "Movano-e", "Combo"]),
  M("peugeot", "Peugeot", "Francuska", ["Partner", "e-Partner", "Rifter", "Expert", "e-Expert", "Boxer", "e-Boxer", "Bipper"]),
  M("piaggio", "Piaggio", "Italija", ["Porter"]),
  M("renault", "Renault", "Francuska", ["Kangoo", "Kangoo E-Tech", "Express Van", "Trafic", "Trafic E-Tech", "Master", "Master E-Tech", "Kangoo Express"]),
  M("seat", "Seat", "Španjolska"),
  M("skoda", "Škoda", "Češka"),
  M("ssangyong", "SsangYong", "Južna Koreja", ["Musso"]),
  M("suzuki", "Suzuki", "Japan"),
  M("taylor-dunn", "Taylor-Dunn", "SAD"),
  M("toyota", "Toyota", "Japan", ["Proace", "Proace City", "Proace Verso", "Proace Max", "Hilux"]),
  M("volkswagen", "Volkswagen", "Njemačka", ["Caddy Cargo", "Caddy Maxi", "Transporter T6.1", "Transporter T7", "ID. Buzz Cargo", "Crafter", "e-Crafter", "Caddy", "Transporter", "ID.Buzz Cargo"]),
  M("yugo", "Yugo", "Srbija"),
