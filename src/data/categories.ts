...
import { PROSTI_CAS_KAMPERI_MAKES, PROSTI_CAS_KAMP_PRIKOLICE_MAKES, PROSTI_CAS_MOBILNE_KUCICE_MAKES, PROSTI_CAS_MODULI_MAKES, PROSTI_CAS_SATORSKE_MAKES } from "./makes-prosti-cas";
import {
 ...
 * KAMPER i ŠATORSKIH PRIKOLICA polje "Model" se NE
...
export function showsModelField(categorySlug: string, subcategory?: string): boolean {
  if (categorySlug === "prosti-cas" && (subcategory === "kamperi" || subcategory === "kamp-prikolice" || subcategory === "mobilne-kucice" ||
      subcategory === "moduli-za-kamper" || subcategory === "satorske-prikolice")) return false;
  return true;
}
