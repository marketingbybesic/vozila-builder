...
export const metadata: Metadata = { title: "Moj parking" };
  ...
  return (
    <div>
      <header className="mb-8">
        <h1 className="font-display text-3xl md:text-4xl tracking-tight">Moj parking</h1>
      ...
      {saved.length === 0 ? (
        <div className="bg-[var(--color-surface)] rounded-[var(--radius-lg)] border border-[var(--color-line)] p-12 text-center">
          ...
          <h2 className="font-display text-xl mt-5">Još nemaš parkiranih oglasa</h2>
          <p className="mt-2 text-sm text-[var(--color-ink-soft)] max-w-md mx-auto">
            Klikni ikonu parkinga na oglasu koji ti se sviđa — vratimo ti se s njim ovdje. Pratimo i promjene cijene.
          </p>
